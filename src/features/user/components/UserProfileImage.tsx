...
/**
 * React functional component for displaying and editing a user's profile image.
 *
 * @param {Object} props - The component props.
 * @param {User} props.user - The user object containing user details.
 * @param {boolean} props.isEditable - Indicates whether the profile image is editable.
